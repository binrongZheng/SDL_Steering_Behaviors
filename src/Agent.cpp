...
void Agent::draw()
{
	...
	else 
	{
		...
		SDL_RenderDrawLine(TheApp::Instance()->getRenderer(), (int)position.x, (int)position.y, (int)(position.x+80*cos(orientation*DEG2RAD)), (int)(position.y+80*sin(orientation*DEG2RAD)));
	}
}
